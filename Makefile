...
rk3228:
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -flto -c oldbloom/bloom.cpp -o oldbloom.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -flto -c bloom/bloom.cpp -o bloom.o
	$(CC) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wno-unused-result -Ofast -ftree-vectorize -funroll-loops -ffast-math -c base58/base58.c -o base58.o
	$(CC) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c xxhash/xxhash.c -o xxhash.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c util.c -o util.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c sha3/sha3.c -o sha3.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c sha3/keccak.c -o keccak.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c hashing.c -o hashing.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c gmp256k1/Int.cpp -o Int.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c gmp256k1/Point.cpp -o Point.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c gmp256k1/GMP256K1.cpp -o GMP256K1.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -c gmp256k1/IntMod.cpp -o IntMod.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -flto -c gmp256k1/Random.cpp -o Random.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -flto -c gmp256k1/IntGroup.cpp -o IntGroup.o
	$(CXX) -march=armv7-a+neon-vfpv4 -mtune=cortex-a7 -mfpu=neon-vfpv4 -mfloat-abi=hard -Wall -Wextra -Ofast -ftree-vectorize -funroll-loops -ffast-math -o keyhunt keyhunt_legacy.cpp base58.o bloom.o oldbloom.o xxhash.o util.o Int.o Point.o GMP256K1.o IntMod.o IntGroup.o Random.o hashing.o sha3.o keccak.o -lm -lpthread -lcrypto -lgmp
	rm -r *.o
